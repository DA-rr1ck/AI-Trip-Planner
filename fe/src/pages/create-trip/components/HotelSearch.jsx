    ...
    <div className='border-2 border-gray-200 rounded-xl p-6 bg-white shadow-sm'>
      <div className='flex items-start gap-4 mb-6'>
        ...
        <div className='flex-1'>
                ...
                return (
                  ...
                  >
                    <div className='flex items-start justify-between'>
                      ...
                      {isSelected && (
                        <svg className='w-6 h-6 text-blue-600 flex-shrink-0 ml-2' fill='currentColor' viewBox='0 0 20 20'>
          ...
          {/* No Results */}
          {!searchingHotels && hotelSearchQuery && hotelResults.length === 0 && (
            <div className='text-center py-8 text-gray-500'>
              <p>No hotels found. Try searching with different keywords or check the spelling.</p>
            </div>
          )}
