// fe/src/pages/edit-trip/components/TripRegenerationSection.jsx
import React from 'react'
import DatePicker from 'react-datepicker'
import Button from '@/components/ui/Button'
import { X, Minus, Plus, DollarSign, Sparkles, Loader2 } from 'lucide-react'
...
function TripRegenerationSection({
  ...
  if (!isEditingSelection) return null
  ...
  return (
    <div className='mb-8 p-6 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl border-2 border-purple-200'>
      <h2 className='font-bold text-2xl mb-4 text-purple-900'>Regenerate Entire Trip</h2>
      
      <div className='space-y-6'>
        {/* Date Range */}
        <div>
          <label className='block text-sm font-medium text-purple-900 mb-2'>Trip Dates</label>
          ...
          {editedSelection.startDate && editedSelection.endDate && (
            <p className='mt-2 text-sm text-purple-700'>
              ✈️ Trip duration: {totalDays} days
            </p>
          )}
        </div>
        ...
        {editedSelection.children > 0 && (
          <div className='p-4 border rounded-lg bg-gradient-to-br from-purple-50 to-pink-50'>
            ...
            <p className='text-xs text-gray-600 mb-3'>
              Select the age of each child (0-17 years)
            </p>
...
export default TripRegenerationSection